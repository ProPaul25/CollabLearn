// lib/stream_page.dart - DEFINES Announcement, IMPORTS AssignmentItem (FIXED)
...
// IMPORTANT: Import data models from their source of truth
import 'study_materials_view_page.dart' show AssignmentItem; 

// --- DATA MODEL (SOURCE OF TRUTH for Announcements) ---
class Announcement {
  final String id;
  final String title;
    ...
    return Card(
      ...
      child: ListTile(
        ...
        onTap: () {
          ...
          // This call works because Assignment and AssignmentItem are defined in the same file.
